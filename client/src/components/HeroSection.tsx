      ...
      <div className="container relative z-10 py-24 md:py-0">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-10">
          ...
          <div className="flex-1 text-center md:text-right order-2 md:order-1">
            ...
            >
              <span className="font-[Amiri] text-[#bf4240] text-base tracking-wider font-bold">
                كاتب ومحلل
              </span>
            </div>
            ...
            >
              ...
              <a
                ...
                className="border-2 border-[#87b0b6] hover:border-[#6a9199] hover:bg-[#87b0b6]/10 text-[#87b0b6] hover:text-[#6a9199] flex items-center gap-2 px-5 py-2.5 rounded-lg transition-all duration-300 font-[Amiri] text-sm"
              >
                <Instagram size={18} />
