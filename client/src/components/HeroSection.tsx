      ...
      <div className="container relative z-10 py-24 md:py-0">
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-10">
          ...
          <div className="flex-1 text-center md:text-right order-2 md:order-1">
            ...
            {/* Tagline */}
            <p
              className="font-[Amiri] text-base md:text-lg text-[#455a5d] font-bold max-w-lg mb-8 leading-relaxed"
            ...
            >
              <a
                ...
                className="border-2 border-[#87b0b6] bg-transparent hover:bg-[#87b0b6]/20 text-[#455a5d] flex items-center gap-2 px-8 py-2.5 rounded-lg transition-all duration-300 font-[Amiri] text-sm"
              >
                اقرأ المقالات
              </a>
              <a
