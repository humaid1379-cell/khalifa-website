...
const timeline = [
  ...
  {
    year: "الحالي",
    title: "رئيس تنفيذي في مؤسسة استثمارية",
    description: "يعمل رئيساً تنفيذياً في إحدى المؤسسات الاستثمارية الإماراتية، حيث يجمع بين الخبرة المؤسسية والإدارة الدولية والاهتمام الإعلامي المتميز.",
  },
];
...
const achievements = [
  ...
  "كاتب منتظم في صحف إماراتية وخليجية وعربية رائدة",
  "خبرة متكاملة بين الإدارة المؤسسية والتحليل الإعلامي المتخصص",
];
      ...
      <div className="container">
        ...
        <AnimatedSection delay={500} className="mt-14 bg-white rounded-xl p-8 border border-[#e8f0ec]">
          <p className="font-[Cairo] text-[#4a6b5a] leading-relaxed text-base">
            يجمع خليفة جمعة الرميثي بين الخبرة المؤسسية والإدارة الدولية والاهتمام الإعلامي المتميز. تخرج من جامعة Hope في الولايات المتحدة الأمريكية بتخصص إدارة دولية، وحاصل على ماجستير تنفيذي من جامعة هارفارد في القيادة والتطوير. يعمل حالياً رئيساً تنفيذياً في إحدى المؤسسات الاستثمارية الإماراتية.
          </p>
