...
export default function PodcastSection() {
  return (
    <section id="podcast" className="relative py-32 md:py-40 overflow-hidden" style={{ backgroundColor: '#87b07a' }}>
      ...
      <div className="container relative z-10">
        ...
        <AnimatedSection className="text-center mb-10">
          <p className="font-[Amiri] text-5xl md:text-7xl font-bold text-[#3d5a45] mb-4">البودكاست</p>
        ...
        <AnimatedSection delay={200} className="text-center">
          ...
          <div className="mt-10">
            <Link href="/podcast">
              <span
                className="inline-block font-[Amiri] text-xl font-bold px-8 py-4 rounded-lg text-[#3d5a45] border-2 border-[#3d5a45] hover:bg-[#6a9166] transition-all duration-300 cursor-pointer"
                style={{ backgroundColor: '#87b07a', letterSpacing: '0' }}
              >
                اكتشف البودكاست
              </span>
            </Link>
